...
// [2011-12-19] Shengjie -porting westlake ICS BEGIN
#include <linux/mfd/pm8xxx/vibrator.h>
// [2011-12-19] Shengjie -porting westlake ICS END
...
#define PM8XXX_GPIO_OUTPUT_FUNC_VIN(_gpio, _val, _func, _vin) \
	PM8XXX_GPIO_INIT(_gpio, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, _val, \
...
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	...
	PM8XXX_GPIO_OUTPUT_FUNC_VIN(24, 0, PM_GPIO_FUNC_2, PM_GPIO_VIN_VPH),	 /* Bl: Off, PWM mode */
	PM8XXX_GPIO_INPUT(26,	    PM_GPIO_PULL_UP_30), /* SD_CARD_DET_N */
	PM8XXX_GPIO_OUTPUT(43,	    PM_GPIO_PULL_UP_30), /* DISP_RESET_N */
       PM8XXX_GPIO_INIT(42, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_NO, PM_GPIO_VIN_S4, PM_GPIO_STRENGTH_MED,PM_GPIO_FUNC_NORMAL, 0, 0),/* USB_5V_EN */
	PM8XXX_GPIO_OUTPUT(3,	    0),			 /* OTG_CHG_DISABLE_GPIO */
};

/* Initial PM8921 MPP configurations */
static struct pm8xxx_mpp_init pm8921_mpps[] __initdata = {
	/* External 5V regulator enable; shared by HDMI and USB_OTG switches. */
	PM8XXX_MPP_INIT(7, A_OUTPUT, PM8921_MPP_DIG_LEVEL_VPH, AOUT_CTRL_DISABLE),
	PM8XXX_MPP_INIT(PM8XXX_AMUX_MPP_8, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH8,
								DOUT_CTRL_LOW),
/* BEGIN [Terry_Tzeng][2012/01/09][Add dock resource marco] */
	PM8XXX_MPP_INIT(12, D_INPUT, PM8921_MPP_DIG_LEVEL_S4, DIN_TO_INT),
...
static struct pm8xxx_adc_amux pm8xxx_adc_channels_data[] = {
	...
	{"device_id", ADC_MPP_1_AMUX6, CHAN_PATH_SCALING1, AMUX_RSV1,
		ADC_DECIMATION_TYPE2, ADC_SCALE_DEFAULT},
...
//Shengjie_yu -S [2011-12-16], change volume key to gpio key mapping
#ifndef CONFIG_KEYBOARD_GPIO
//Shengjie_yu -E [2011-12-16]
...
/* BEGIN [Shengjie][2011/12/26] Setup vibrator config */
static struct pm8xxx_vibrator_platform_data pm8xxx_vib_pdata = {
       .initial_vibrate_ms  = 0,
       .level_mV = 3000,
       .max_timeout_ms = 15000,
};
/* END [Shengjie][2011/12/26] Setup vibrator config*/
...
/* BEGIN [Shengjie_Yu][2011/12/26] init vibrator platform data */
	.vibrator_pdata 	= &pm8xxx_vib_pdata,
/* END [Shengjie_Yu][2011/12/26] init vibrator platform data */
};
