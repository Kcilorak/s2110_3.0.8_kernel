...
/* BEGIN Dom_Lin@pegatron [2012/03/09] [Add camera new schematic support after DVT version in 1032 codebase] */
	REGULATOR_SUPPLY("cam_vana_v2",	"4-0078"), /* AVDD */
...
#endif
	REGULATOR_SUPPLY("cam_vana",	"4-0078"), /* AVDD, AF_VDD */
/* END Dom_Lin@pegatron [2012/03/03] [Init back camera drivers in 1032 codebase] */
/* BEGIN Chaoyen_Wu@pegatron [2012/03/08] [Init front camera drivers in 1032 codebase] */
	REGULATOR_SUPPLY("cam_vana",	"4-0048"), /* AVDD, AF_VDD */
...
/* BEGIN Chaoyen_Wu@pegatron [2012.3.13][Add front camera new schematic support after DVT version in 1032 codebase]*/
	REGULATOR_SUPPLY("cam_vana_v2",	"1-0048"), /* AVDD, AF_VDD */
...
/* END Dom_Lin@pegatron [2012/03/03] [Init back camera drivers in 1032 codebase] */
	...
	REGULATOR_SUPPLY("apx9132_l11",		NULL),
    //END Kite_Yeh@pegatron [20120330][map L11 requlator for hall sensor]
#if defined( CONFIG_WESTLAKE)	
	REGULATOR_SUPPLY("dsi_bridge_lvds_vdd",	"mipi_dsi.1"),
	REGULATOR_SUPPLY("gauge_vdd",		"10-0055"),
#endif
};
VREG_CONSUMERS(L12) = {
...
/* END Dom_Lin@pegatron [2012/03/03] [Init back camera drivers in 1032 codebase] */
/* BEGIN Dom_Lin@pegatron [2012/03/09] [Add camera new schematic support after DVT version in 1032 codebase] */
	REGULATOR_SUPPLY("cam_vaf_v2",		"4-0078"), /* AF_VDD */
/* END Dom_Lin@pegatron [2012/03/09] [Add camera new schematic support after DVT version in 1032 codebase] */
};
VREG_CONSUMERS(L17) = {
...
/* BEGIN Chaoyen_Wu@pegatron [2012/03/08] [Init front camera drivers in 1032 codebase] */
	REGULATOR_SUPPLY("pll_vdd",		"4-0048"),  /*DVDD*/
/* END Chaoyen_Wu@pegatron [2012/03/08] [Init front camera drivers in 1032 codebase] */	
/* BEGIN Chaoyen_Wu@pegatron [2012.3.13][Add front camera new schematic support after DVT version in 1032 codebase]*/
	REGULATOR_SUPPLY("pll_vdd_v2", 	"1-0048"),	/*DVDD*/
/* END Chaoyen_Wu@pegatron [2012.3.13][Add front camera new schematic support after DVT version in 1032 codebase]*/	
};
VREG_CONSUMERS(L24) = {
...
/* BEGIN Dom_Lin@pegatron [2012/03/03] [Init back camera drivers in 1032 codebase] */
	REGULATOR_SUPPLY("cam_vdig",		"4-0078"), /* DOVDD */
/* END Dom_Lin@pegatron [2012/03/03] [Init back camera drivers in 1032 codebase] */
/* BEGIN Chaoyen_Wu@pegatron [2012/03/08] [Init front camera drivers in 1032 codebase] */
	REGULATOR_SUPPLY("cam_vdig",		"4-0048"), /* DOVDD */
/* END Chaoyen_Wu@pegatron [2012/03/08] [Init front camera drivers in 1032 codebase] */
/* BEGIN Chaoyen_Wu@pegatron [2012.3.13][Add front camera new schematic support after DVT version in 1032 codebase]*/
	REGULATOR_SUPPLY("cam_vdig_v2",		"1-0048"), /* DOVDD */
/* END Chaoyen_Wu@pegatron [2012.3.13][Add front camera new schematic support after DVT version in 1032 codebase]*/	
};
VREG_CONSUMERS(S1) = {
...
#endif
	REGULATOR_SUPPLY("cam_vio",		"4-0078"), /* I2C pull high */
	REGULATOR_SUPPLY("cam_vio",		"4-0048"),
/* END Dom_Lin@pegatron [2012/03/03] [Init back camera drivers in 1032 codebase] */
/* BEGIN Dom_Lin@pegatron [2012/03/09] [Add camera new schematic support after DVT version in 1032 codebase] */
	REGULATOR_SUPPLY("cam_vdig_v2",	"4-0078"), /* DOVDD and I2C pull high */
/* END Dom_Lin@pegatron [2012/03/09] [Add camera new schematic support after DVT version in 1032 codebase] */
};
VREG_CONSUMERS(LVS6) = {
...
VREG_CONSUMERS(EXT_5V) = {
	...
	REGULATOR_SUPPLY("hdmi_boost_5v",		NULL),

#if defined( CONFIG_WESTLAKE)
/*-----------Pau Modified for Westlake Project-------------*/

	REGULATOR_SUPPLY("SPKR_VDD",	"soc-audio.0"),
	REGULATOR_SUPPLY("SPKL_VDD",	"soc-audio.0"),
...
/* BEGIN [2012/02/14][Terry_Tzeng][Create regulator to control tablet 5v boost power switch for dock in charging devices] */
VREG_CONSUMERS(EXT_OTG_SW) = {
	REGULATOR_SUPPLY("ext_otg_sw",		NULL),
	REGULATOR_SUPPLY("vbus_otg",		"msm_otg"),
	REGULATOR_SUPPLY("ecchg_tb_5vbst",	"msm-charger"),
};
/* END [2012/02/14][Terry_Tzeng][Create regulator to control tablet 5v boost power switch for dock in charging devices] */
...
msm_pm8921_regulator_pdata[] __devinitdata = {
	...
	PM8XXX_NLDO1200(L28, "8921_l28", 0, 1, 1050000, 1050000, 200, "8921_s7",
		0, 3),
/* BEGIN BEGIN Dom_Lin@pegatron [2012/03/03] [Init back camera drivers in 1032 codebase] */
	PM8XXX_LDO(L29,      "8921_l29", 0, 1, 1800000, 1800000, 200, "8921_s8",
		0, 4),
/* END BEGIN Dom_Lin@pegatron [2012/03/03] [Init back camera drivers in 1032 codebase] */
...
/* END BEGIN Dom_Lin@pegatron [2012/03/03] [Init back camera drivers in 1032 codebase] */
	RPM_LDO(L9,	 0, 1, 0, 2600000, 2600000, NULL,      0, 0),
	...
	RPM_LDO(L15,	 0, 1, 0, 3000000, 3000000, NULL,      0, 0),
/* BEGIN Dom_Lin@pegatron [2012/03/09] [Add camera new schematic support after DVT version in 1032 codebase] */
