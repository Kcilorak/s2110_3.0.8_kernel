...
/*chilung, 20120302, reduce drive current to 2mA start*/
static struct gpiomux_setting gsbi5 = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,  // GPIOMUX_DRV_8MA -> GPIOMUX_DRV_2MA
	.pull = GPIOMUX_PULL_NONE,
};
/*chilung, 20120302, reduce drive current to 2mA end*/
...
/* BEGIN Acme_Wen@pegatroncorp.com [2012/02/29] [8MA -> 2MA] */
static struct gpiomux_setting gsbi12 = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
/* END Acme_Wen@pegatroncorp.com [2012/02/29] [8MA -> 2MA] */
...
#endif
/* BEGIN-20111221-paul mark gpio 14 setting, it doesn't suit westlake project */
...
#endif
/* END-20111221-paul mark gpio 14 setting, it doesn't suit westlake project */
	{
...
/*robert1_chen, 20120409, for Dock GSBI change*/
	{
		...
		.settings	={
			...
			[GPIOMUX_ACTIVE] = &gsbi9,	//0411 for gsbi9 recovery
		},
	},
	{
		.gpio	=96,
...
#if 0 /*robert1_chen, 20120409, for Dock GSBI change*/	
	/* AP2MDM_ERRFATAL */
	{
		.gpio = 95,
		.settings = {
...
#ifdef CONFIG_EC /*1109 set the EC GP11*/
static struct gpiomux_setting EC_msm8960[]={
	{
		.func = GPIOMUX_FUNC_GPIO,
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_UP,	
...
static struct msm_gpiomux_config msm8960_EC_configs[]__initdata = 
{
	{
		.gpio      = 7,	/* GP7_EC_docking_det before SIT1*/
		.settings = 
		{
			[GPIOMUX_ACTIVE] = &EC_msm8960[0],
			[GPIOMUX_SUSPENDED] = &EC_msm8960[0],
		},		
	},
	{
		.gpio      = 35,	/* GP35_EC_docking_det After SIT2*/
		.settings = 
		{
			[GPIOMUX_ACTIVE] = &EC_msm8960[0],
			[GPIOMUX_SUSPENDED] = &EC_msm8960[0],
	...
	},
	{
		...
		.settings = 
		{
			[GPIOMUX_ACTIVE] = &EC_msm8960[1],
			[GPIOMUX_SUSPENDED] = &EC_msm8960[1],
		},
	},
//--------0307-WeiHuai
	{
		.gpio      = 34,	/* GP34_EC_reset */
		.settings = 
		{
			[GPIOMUX_ACTIVE] = &EC_msm8960[2],
			[GPIOMUX_SUSPENDED] = &EC_msm8960[2],
		},
	},
//--------------------
...
static struct gpiomux_setting TS_lgd_msm8960[]={
	{ /* GPIO, no pull */
		.func = GPIOMUX_FUNC_GPIO,
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_NONE,
...
#define GP3_TOUCH_ID   3
#define GP46_TOUCH_RESET_N   46
#define GP47_TP_5V_SW_EN     47
#define GP49_TOUCH_INT_N     49
#define GP58_TOUCH_WAKE_UP   58

static struct msm_gpiomux_config msm8960_lgd_touchscreen_configs[]__initdata = {
	{
		.gpio      = GP3_TOUCH_ID,
		.settings =
		{
			[GPIOMUX_SUSPENDED] = TS_lgd_msm8960,
		},
	},
	{
		.gpio      = GP46_TOUCH_RESET_N,
		.settings =
		{
			[GPIOMUX_SUSPENDED] = TS_lgd_msm8960,
		},
	...
	{
		.gpio      = GP49_TOUCH_INT_N,
		.settings =
		{
			[GPIOMUX_SUSPENDED] = TS_lgd_msm8960,//20111216_Jack: interrupt Pin GPIO  default no pull
		},
	},
	{
		.gpio      = GP58_TOUCH_WAKE_UP,
		.settings =
		{
			[GPIOMUX_SUSPENDED] = TS_lgd_msm8960,
		},
...
#ifdef CONFIG_EC	/*1109 for EC I2C*/
	msm_gpiomux_install(msm8960_EC_configs,
		ARRAY_SIZE(msm8960_EC_configs));
#endif

#ifdef CONFIG_TOUCHSCREEN_LGD_I2C	/*[BEGIN] CONFIG_TOUCHSCREEN_LGD_I2C */
	msm_gpiomux_install(msm8960_lgd_touchscreen_configs,
		ARRAY_SIZE(msm8960_lgd_touchscreen_configs));
#endif /*[END] CONFIG_TOUCHSCREEN_LGD_I2C */
