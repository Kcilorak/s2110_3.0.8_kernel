...
#if 1 /*robert1_chen, 20120409, for Dock GSBI change*/
...
/* BEGIN Chaoyen_Wu@pegatron [2012.3.13][Add front camera new schematic support after DVT version in 1032 codebase]*/
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"1-0048"),
/* END Chaoyen_Wu@pegatron [2012.3.13][Add front camera new schematic support after DVT version in 1032 codebase]*/	
...
/* BEGIN Dom_Lin@pegatron [2011/01/16] [Add camera support for 8060A (soc version is 1.4)] */
		if (SOCINFO_VERSION_MAJOR(socinfo_get_version()) >= 1) {
/* END Dom_Lin@pegatron [2011/01/16] [Add camera support for 8060A (soc version is 1.4)] */
