...
#define MSM_CAM_RESP_S_STAT_EVT_MSG    8
...
/* BEGIN Dom_Lin@pegatron [2011/02/04] [Enable back camera auto focus] */
#define CFG_SET_SENSOR_AUTO_FOCUS		36
/* END Dom_Lin@pegatron [2011/02/04] [Enable back camera auto focus] */
/* BEGIN Dom_Lin@pegatron [2012/02/12] [Enable back camera scene mode] */
#define CFG_SET_BESTSHOT_MODE			37
...
#define CFG_SET_EXP_COMPENSATION	38
/*END Chaoyen_Wu@pegatron[2012.2.15][Enable camera exposure compensation]*/
#define CFG_SET_SENSOR_TOUCH_FOCUS		39
...
/*BEGIN Chaoyen@pegatron [2012.2.14][Enable camera contrast]*/
#define CAMERA_CONTRAST_LV10			10
#define CAMERA_CONTRAST_LV11			11
#define CAMERA_CONTRAST_LV12			12
/*END Chaoyen@pegatron [2012.2.14][Enable camera contrast]*/
...
/*BEGIN Chaoyen_Wu@pegatron [2012.2.20][Enable camera saturation]*/	
	MSM_V4L2_SATURATION_L11,
	MSM_V4L2_SATURATION_L12,
/*ENDChaoyen_Wu@pegatron [2012.2.20][Enable camera saturation]*/		
};
...
/*BEGIN Chaoyen_Wu@pegatron [2012.2.20][Enable camera sharpness]*/	
...
/*END Chaoyen_Wu@pegatron [2012.2.20][Enable camera sharpness]*/	
};
...
struct strobe_flash_ctrl_data {
	...
	int charge_en;
/* BEGIN Dom_Lin@pegatron [2012/03/08] [Enable auto flash function in 1032 codebase] */
	int mode;
/* END Dom_Lin@pegatron [2012/03/08] [Enable auto flash function in 1032 codebase] */
};
