...
extern int is_default_serialno_status(void);
...
static int hw_device_reset(struct ci13xxx *udc)
{
	...
	if (hw_cread(CAP_USBMODE, USBMODE_CM) != USBMODE_CM_DEVICE) {
       ...
       /*chilung 20120629, change usb spped to FS, if usb serial number is 12345678, begin*/
	if(is_default_serialno_status())
	{
		printk("Writing to PTC FS mode\n");
		hw_cwrite(CAP_PORTSC,BIT(24), BIT(24));
	}
       /*chilung 20120629, change usb spped to FS, if usb serial number is 12345678, end*/
