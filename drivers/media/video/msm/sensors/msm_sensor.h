...
/* BEGIN Chaoyen_Wu@pegatron [2012.2.8] [Enable camera effect] */
	int32_t (*sensor_set_effect) (struct msm_sensor_ctrl_t *, uint8_t);
/* END Chaoyen_Wu@pegatron [2012.2.8] [Enable camera effect] */
/* BEGIN Dom_Lin@pegatron [2012/02/12] [Enable back camera scene mode] */
	int32_t (*sensor_set_bestshot_mode) (struct msm_sensor_ctrl_t *, uint8_t);
...
/*BEGIN Chaoyen_Wu@pegatron[2012.2.15][Enable camera exposure compensation]*/
	int32_t (*sensor_set_exp_compensation) (struct msm_sensor_ctrl_t *, uint32_t);
...
/*BEGIN Chaoyen_Wu@pegatron[2012.2.15][Enable camera anti-banding]*/
	int32_t (*sensor_set_antibanding) (struct msm_sensor_ctrl_t *, uint8_t);
...
/* BEGIN Dom_Lin@pegatron [2012/02/20] [Enable back camera touch focus] */
	int32_t (*sensor_set_touch_focus) (struct msm_sensor_ctrl_t *, struct sensor_roi_t);
...
/* BEGIN Dom_Lin@pegatron [2012/04/27] [Release AF when setting focus mode Infinity] */
	int32_t (*sensor_set_release_af) (struct msm_sensor_ctrl_t *);
