 ...
 */
static struct msm_panel_info boe_wxga_pinfo;
...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
	...
	/* DSIPHY_TIMING_CTRL */
	.timing = { 0x66, 0x26, 0x18, /* panel specific */
	0, /* DSIPHY_TIMING_CTRL_3 = 0 */
	0x1b, 0x90, 0x1e, 0x8d, 0x1b, 0x03, 0x04},  /* panel specific */
	/* DSIPHY_PLL_CTRL */
...
module_init(mipi_boe_wxga_init);

MODULE_LICENSE("GPL v2");
MODULE_DESCRIPTION("Boe WXGA LVDS Panel driver");
